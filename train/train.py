...
def train_model(
    ...
    try:
        ...
        #print(dataset[0]['image'].shape, dataset[0]['mask'].squeeze(0).shape)
    ...
    for epoch in range(1, epochs + 1):
        ...
        if save_checkpoint:
            ...
            torch.save(state_dict, str(paths['checkpoint'] / 'checkpoint_epoch{}.pth'.format(epoch)))
...
if __name__ == '__main__':
    '''
    train_dataset = SegDataSet(paths['train'], transform=Transforms.Resize(image_size))
    ...
    for i in range(len(train_dataset)):
        ...
        print(img.shape, mask.shape,'name is ', train_dataset.img_raw[i])
    '''
